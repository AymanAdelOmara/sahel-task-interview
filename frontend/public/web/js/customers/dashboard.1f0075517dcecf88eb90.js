...
var render = function render() {
  ...
  return _c("div", [_c("section", {
    ...
    return _c("div", {
      staticClass: "col-md-4 col-6 mt-3 text-left"
    }, [_c("div", {
      staticClass: "gry-border shadow"
    }, [_c("div", {
      staticClass: "p-2"
    }, [_c("h5", {
      staticClass: "gift_title font-weight-bolder"
    ...
    staticClass: "col-md-3 col-6 pt-lg-2"
    ...
    return _c("div", {
      staticClass: "p-2 bg-gray-300 shadow"
    }, [_c("h4", {
      ...
      staticClass: "gift_title"
    }, [_vm._v("Price: $" + _vm._s(orderProduct.price) + " - Discount: $" + _vm._s(orderProduct.discountAmount))]), _vm._v(" "), _c("h5", {
      staticClass: "gift_title"
    }, [_vm._v("Shipped Amount: $" + _vm._s(orderProduct.shippingAmount))])]);
  }), _vm._v(" "), this.order != null ? _c("div", {
    staticClass: "p-2 bg-gray-300 border-top"
  }, [_c("h5", {
    staticClass: "gift_title"
  }, [_vm._v("Sub Total: $" + _vm._s(_vm.order.subTotal))]), _vm._v(" "), _c("h5", {
    staticClass: "gift_title"
  }, [_vm._v("Shipping: $" + _vm._s(_vm.order.shippingAmount) + " - VAT: $" + _vm._s(_vm.order.vatAmount))]), _vm._v(" "), _vm.order.discountsAmount > 0 || _vm.order.shippingAmountDiscount > 0 ? _c("h5", {
    staticClass: "gift_title"
  }, [_vm._v("\n                            Discounts:\n                            "), _vm._l((_this$order2 = this.order) === null || _this$order2 === void 0 ? void 0 : _this$order2.orderItems, function (orderProduct) {
    var _vm$products$find2;
    return orderProduct.discountAmount > 0 ? _c("span", {
      staticClass: "d-block pl-2 pb-1"
    }, [_vm._v("\n                                " + _vm._s(orderProduct.discountPercent) + "% off\n                                " + _vm._s((_vm$products$find2 = _vm.products.find(function (product) {
      return product.id === orderProduct.productId;
    })) === null || _vm$products$find2 === void 0 ? void 0 : _vm$products$find2.name) + ": -$" + _vm._s(orderProduct.discountAmount) + "\n\n                            ")]) : _vm._e();
  }), _vm._v(" "), _vm.order.shippingAmountDiscount > 0 ? _c("span", {
    staticClass: "d-block pl-2"
  }, [_vm._v("\n                                $" + _vm._s(_vm.order.shippingAmountDiscount) + " of shipping: -$" + _vm._s(_vm.order.shippingAmountDiscount) + "\n                            ")]) : _vm._e()], 2) : _vm._e(), _vm._v(" "), _c("h5", {
    staticClass: "gift_title font-weight-bolder"
  }, [_vm._v("Total Amount: $" + _vm._s(_vm.order.totalAmount))])]) : _vm._e()], 2)]), _vm._v(" "), _c("infinite-loading", {
    attrs: {
      slot: "{}",
      spinner: "waveDots"
    },
      ...
      var _getProducts = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(page) {
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return this.http.get(this.http.baseUrl + '/api/v1/customer/products?page=' + page);
            case 2:
      ...
      var _orderCheckout = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(productsIds) {
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return this.http.post(this.http.baseUrl + '/api/v1/customer/order-checkout', {
