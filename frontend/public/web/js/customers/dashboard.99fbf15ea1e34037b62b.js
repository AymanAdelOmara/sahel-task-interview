...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _services_API__WEBPACK_IMPORTED_MODULE_1__["APIService"].getProducts(_this.query).then(function (result) {
    ...
    getNextPage: function getNextPage($state) {
      var _this2 = this;
      _services_API__WEBPACK_IMPORTED_MODULE_1__["APIService"].getProducts(this.query).then(function (result) {
        if (result.data.products.length > 0) {
          var _this2$products;
          (_this2$products = _this2.products).push.apply(_this2$products, _toConsumableArray(result.data.products));
          $state.loaded();
          _this2.page++;
        } else {
          $state.complete();
...
var render = function render() {
  ...
  return _c("div", [_c("section", {
    ...
    return _c("div", {
      ...
      staticClass: "gift_title"
    }, [_vm._v(_vm._s(product.price))]), _vm._v(" "), _c("h5", {
      staticClass: "gift_title"
    }, [_vm._v(_vm._s(product === null || product === void 0 || (_product$shipped_from = product.shipped_from) === null || _product$shipped_from === void 0 ? void 0 : _product$shipped_from.name))])]), _vm._v(" "), _c("div", {
...
var API = /*#__PURE__*/function () {
  ...
  _createClass(API, [{
      ...
      var _getProducts = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return this.http.get(this.http.baseUrl + '/api/v1/products');
            case 2:
    ...
    key: "promoCodePay",
    value: function () {
      var _promoCodePay = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(orderData) {
