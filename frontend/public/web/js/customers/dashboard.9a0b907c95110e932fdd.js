  ...
  methods: {
    ...
    addProductToCart: function addProductToCart(product) {
      if (!this.cartProducts.includes(product.id)) {
        ...
        _services_API__WEBPACK_IMPORTED_MODULE_1__["APIService"].cartCheckout(this.cartProducts).then(function (result) {
          console.log(result);
        });
      }
    },
...
var API = /*#__PURE__*/function () {
  ...
  _createClass(API, [{
    ...
    key: "cartCheckout",
    value: function () {
      var _cartCheckout = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(productsIds) {
      ...
      function cartCheckout(_x2) {
        return _cartCheckout.apply(this, arguments);
      }
      return cartCheckout;
    }()
  }]);
