...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              !(function webpackMissingModule() { var e = new Error("Cannot find module '../../services/Auth'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).getGiftCard(_this.page, _this.selectedCategory).then(function (result) {
                if (_this.giftCardsTypes.length == 0) {
                  !(function webpackMissingModule() { var e = new Error("Cannot find module '../../services/Auth'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).getGiftCardsTypes().then(function (result) {
    ...
    getNextPage: function getNextPage($state) {
      var _this2 = this;
      !(function webpackMissingModule() { var e = new Error("Cannot find module '../../services/Auth'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).getGiftCard(this.page).then(function (result) {
