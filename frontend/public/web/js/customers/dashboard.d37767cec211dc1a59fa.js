...
var API = /*#__PURE__*/function () {
  ...
  _createClass(API, [{
    ...
    value: function () {
      var _addProductToCart = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(productsIds) {
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return this.http.post(this.http.baseUrl + '/api/v1/order-checkout', productsIds);
            case 2:
